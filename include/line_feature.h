...
namespace line_feature
{
    ...
    public:
        ...
        void setRangeData(const std::vector<double>& xs, const std::vector<double>& ys);
        ...
        void set_max_range(double r) { m_max_range = r; }
        ...
        int get_laser_points_num() { return params_.laser_points_num; }
    ...
    private:
        ...
        // if using 360 deg laser scanner, merge head and points.
        void MergeHeadTailLines(std::vector<line> &lines);

        // for unlabeled points between two line segments, 
        // generate vertical lines from closer line segment,
        // then check fitting error, 
        // if all continuous points (include invalid points) are within this error,
        // also minimal five points are required.
        // generate this new virtual line.
        void generateVirtualLines(); 
